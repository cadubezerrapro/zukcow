...
export async function updatePosition(x, y, direction, currentRoom = null) {
    const { data } = await api.post(`${API_BASE}?action=update_position`, buildParams({ x, y, direction, current_room: currentRoom }));
    return data;
}
